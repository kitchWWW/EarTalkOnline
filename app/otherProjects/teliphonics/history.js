...
function backToStart(){
  window.location.href = '/otherProjects/teliphonics'
}
...
document.getElementById("myInput").value=window.location.origin+'/otherProjects/teliphonics/play.html?clipToUse='+clipToUse+'&jumpToEndOfChain=true';
